...
const VERSION = "idmon-0603b443ca";
const CACHE = `${VERSION}`;
 ...
 * ediyor, ve `sw-register.ts` tek satırlık bir bant çıkarıp devri kullanıcıya
 * bırakıyor. Bant dokunulduğunda buraya bu ileti geliyor.
 */
